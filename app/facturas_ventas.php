    ...
    try {
        ...
        if ($existing_invoice_id) {
            ...
            if ($preselect_parte_ruta_id) {
                header("Location: partes_ruta.php?view_id=" . htmlspecialchars($preselect_parte_ruta_id));
            } else {
        ...
        if ($any_invoiced_units) { // Only create invoice if at least one unit was invoiced
            ...
            if ($preselect_parte_ruta_id) {
                $redirect_url = "partes_ruta.php?view_id=" . htmlspecialchars($preselect_parte_ruta_id);
            }
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        <?php if ($factura['id_parte_ruta_origen']): ?>
                                                            <a href="partes_ruta.php?view_id=<?php echo htmlspecialchars($factura['id_parte_ruta_origen']); ?>" class="badge bg-purple">Parte #<?php echo htmlspecialchars($factura['id_parte_ruta_origen']); ?></a>
                                                        <?php else: ?>
                                                            <span class="badge bg-secondary">N/A</span>
                                                        <?php endif; ?>
                                                    </td>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-3 invoice-header-details">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <?php if ($factura_actual['id_parte_ruta_origen']): ?>
                                        <p><strong>Parte de Ruta Origen:</strong> <a href="partes_ruta.php?view_id=<?php echo htmlspecialchars($factura_actual['id_parte_ruta_origen']); ?>" class="btn btn-sm btn-outline-purple"><i class="bi bi-truck"></i> Ver Parte #<?php echo htmlspecialchars($factura_actual['id_parte_ruta_origen']); ?></a></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <?php if ($current_parte_ruta_id): ?>
                                <a href="partes_ruta.php?view_id=<?php echo htmlspecialchars($current_parte_ruta_id); ?>" class="btn btn-info mb-3 ms-2">
